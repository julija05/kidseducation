...
Route::middleware(['auth', 'verified', 'role:parent', 'check.user.status'])->prefix('parent')->name('parent.')->group(function () {
    ...
    Route::get('/children/{child}/learning-dashboard', [ParentDashboardController::class, 'showChildLearningDashboard'])->name('children.learning-dashboard');
...
Route::middleware(['auth', 'role:admin', 'admin.english'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::resource('learning-groups', AdminLearningGroupController::class)->only(['index', 'create', 'store', 'show']);
