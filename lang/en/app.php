...
return [
    ...
    'waiting_list' => [
        'welcome_title' => 'You\'re on the Waiting List! 🎉',
        'success_message' => 'You\'ve successfully joined the waiting list for :program!',
        'contact_info' => 'We\'ll contact you at :email with program details and launch information soon!',
        'added_on' => 'Added to waiting list on:',
    ...
    'dashboard' => [
        ...
        'pending_approval' => 'On Waiting List',
        'approved' => 'Approved',
        'rejected' => 'Rejected',
        ...
        'enrollment_request_pending' => 'Added to Waiting List',
        'enrollment_request_sent' => 'You have been added to the waiting list for :program successfully!',
        'enrollment_review_message' => 'You are now on our waiting list! We will contact you at your email address with program details and next steps as we prepare for launch.',
        'requested_on' => 'Requested on',
        'cancel_enrollment_request' => 'Leave waiting list',
        'cancel_enrollment_title' => 'Leave Waiting List?',
        'cancel_enrollment_confirm' => 'Are you sure you want to leave the waiting list for :program?',
        'keep_request' => 'Stay on List',
        'yes_cancel' => 'Yes, Leave',
        'canceling' => 'Canceling...',
        ...
        'enrollment_pending_other' => 'You are already on a waiting list',
    ...
    'programs_page' => [
        ...
        'interactive_lessons_desc' => 'Engaging video content and hands-on activities',
        'certificate_desc' => 'Complete the program and earn your certificate',
        'expert_support' => 'Expert Support',
        'expert_support_desc' => 'Get help from our experienced instructors',
        'skill_building' => 'Skill Building',
        'skill_building_desc' => 'Progressive learning with clear milestones',
        'step_by_step' => 'Step-by-Step Learning',
        'step_by_step_desc' => 'Structured curriculum designed for optimal learning progression',
