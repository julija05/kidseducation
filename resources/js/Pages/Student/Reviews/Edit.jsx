...
export default function EditReview({ review, program }) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title={`Edit Review - ${program.name}`} />
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <Link
                            ...
                            data-confirm="Are you sure you want to delete your review? This action cannot be undone."
                        >
                            <Trash2 size={16} />
                    ...
                    <p className="text-gray-600">
                        Update your experience with <strong>{program.name}</strong>
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                                What has changed about your experience? Any new insights you'd like to share?
                            </p>
                ...
                <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-sm text-gray-600">
                        Your original review was posted on{' '}
