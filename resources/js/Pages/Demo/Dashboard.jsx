                            ...
                            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transform transition-all duration-200 hover:scale-105"
                                    >
                                ...
                                <div className="p-6">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {lockedLessons.slice(0, 6).map((lesson) => (
                                            <div
                                                key={lesson.id}
                                                className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg opacity-60"
                                            >
                        ...
                        <div className="bg-gradient-to-br from-green-400 to-blue-500 rounded-lg p-6 text-white">
                            <div className="text-center">
                                ...
                                <button
                                    ...
                                    disabled={processing}
                                    className="w-full bg-white text-green-600 font-bold py-3 px-6 rounded-lg hover:bg-gray-100 transform transition-all duration-200 hover:scale-105 disabled:opacity-50"
                                >
