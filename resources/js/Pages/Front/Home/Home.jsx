    ...
    return (
        <GuestFrontLayout auth={auth}>
            ...
            >
                ...
                >
                    ...
                    <div className="max-w-lg">
                        ...
                        <p className="text-lg mb-6">
                            Inspiring young minds through interactive learning
                            and play. Discover our programs and join our growing
                            community!
                        </p>
                        <a
                            href="#signup"
                ...
                <div className="custom-shape-divider-bottom-1736693835">
                    <svg
                        data-name="Layer 1"
