                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    ...
                                    <p className="text-sm text-purple-700">
                                        If you didn't receive the email, check your spam folder or click the button below to send another verification email.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <div className="ml-3">
                                    ...
                                    <p className="text-sm text-blue-700 mt-1">
                                        The verification link will expire in 60 minutes for your security. 
