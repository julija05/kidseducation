    ...
    return (
        <>
            ...
            <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-pink-50 relative overflow-hidden px-4 py-12">
                ...
                <div className="absolute bottom-0 -right-10 w-80 h-80 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full blur-3xl opacity-60 animate-bounce" 
                     style={{animationDuration: '6s'}} />
                <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-gradient-to-r from-yellow-200 to-pink-200 rounded-full blur-2xl opacity-40 animate-pulse" 
