...
export default function ResourcesIndex() {
    ...
    const filteredPrograms = programs.filter((program) => {
        ...
        if (filterType === "no-resources") {
            return (
                matchesSearch &&
                program.lessons.some((lesson) => lesson.resources_count === 0)
            );
        }
    ...
    const getTotalResourcesForProgram = (program) => {
        return program.lessons.reduce(
            (sum, lesson) => sum + lesson.resources_count,
            0
        );
    };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-4">
                    {filteredPrograms.map((program) => {
                        ...
                        const lessonsWithoutResources = program.lessons.filter(
                            (l) => l.resources_count === 0
                        ).length;
