...
export default function QuickAddResource() {
    const { program, lessons, resourceTypes } = usePage().props;
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route("admin.programs.resources.storeQuickAdd", program.id), {
            preserveScroll: true,
            onSuccess: () => reset(),
        });
    };
    ...
    const handleTypeChange = (type) => {
        ...
        setData("type", type);
        // Reset URL and file when changing type
        setData({
            ...data,
            type: type,
            resource_url: "",
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                            <div className="flex">
                                ...
                                <div className="text-sm text-yellow-700">
                                    <p className="font-medium">Quiz Creation</p>
                                    <p>
                                        After adding this quiz resource, you'll
                                        be redirected to the quiz builder to
                                        create questions.
                                    </p>
                                </div>
                            </div>
    ...
    return (
        <AdminLayout>
            <Head title={`Quick Add Resource - ${program.name}`} />
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    <Link
                        href={route(
                            "admin.programs.resources.show",
                            program.id
                        )}
                        className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4"
                    >
                        <ArrowLeft size={16} className="mr-1" />
                        Back to {program.name} Resources
                    </Link>
                    <h1 className="text-3xl font-bold text-gray-900">
                        Quick Add Resource
                    </h1>
                    <p className="mt-1 text-gray-600">
                        Add a new learning resource to any lesson in{" "}
                        {program.name}
                    </p>
                </div>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setData("lesson_id", e.target.value)
                                    }
                                    className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                                        errors.lesson_id
                                            ? "border-red-500"
