...
export default function CreateLessonResource() {
                        ...
                        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                            <div className="flex">
                                ...
                                <div className="text-sm text-yellow-700">
                                    ...
                                    <p>
                                        After creating this quiz resource,
                                        you'll be able to add questions in a
                                        separate step.
                                    </p>
                                </div>
                            </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-1 text-gray-600">
                        Add a learning resource to "{lesson.title}"
                    </p>
                </div>
