...
export default function StudentNavBar({ 
    ...
    return (
        <>
            <motion.div 
                className="bg-white/20 backdrop-blur-sm rounded-full p-3 mr-4 border border-white/30 shadow-lg"
            ...
            <Link 
                ...
                className="text-white hover:text-gray-200 transition-colors group"
            >
                <motion.div 
                ...
                >
                    <span className="text-2xl font-bold bg-gradient-to-r from-white to-white/90 bg-clip-text text-transparent group-hover:from-white/90 group-hover:to-white">
                        {displayTitle}
                    </span>
                    <span className="text-xs -mt-1 bg-gray-900/90 text-white backdrop-blur-sm rounded-full px-2 py-0.5 border border-gray-700/50 shadow-sm">
                        {displaySubtitle}
                    </span>
                </motion.div>
            </Link>
