...
const NavBar = React.memo(() => {
    ...
    const navItems = [
        ...
        {
            href: routeWithLocale("programs.index"),
            label: t("nav.programs"),
            icon: BookOpen,
        },
        {
            href: routeWithLocale("about.index"),
            label: t("nav.about"),
            icon: User,
        },
        {
            href: routeWithLocale("articles.index"),
            label: t("nav.help"),
            icon: HelpCircle,
        },
        {
            href: routeWithLocale("contact.index"),
            label: t("nav.contact"),
            icon: Mail,
        },
    ];
    ...
    const isActive = (href) => {
        ...
        try {
            ...
            const currentPathname =
                currentUrlObj.pathname.replace(/\/$/, "") || "/";
