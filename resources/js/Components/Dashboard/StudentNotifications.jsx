            ...
            <div className="relative">
                <button
                    ...
                    className={`relative p-2 sm:p-3 rounded-full transition-colors touch-manipulation ${
                        headerMode
                            ? 'text-aba-ink-soft hover:text-aba-ink border border-aba-line bg-aba-surface shadow-aba-sm'
                            : 'text-gray-600 hover:text-gray-800 hover:bg-gray-100'
                    }`}
                >
                    <Bell className="w-5 h-5 sm:w-6 sm:h-6" />
                    {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 bg-aba-coral text-white text-xs font-black rounded-full w-5 h-5 flex items-center justify-center border-2 border-aba-surface">
