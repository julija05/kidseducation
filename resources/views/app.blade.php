...
<head>
    ...
    <!-- Fonts -->
    {{-- baloo-2 and nunito back the `font-display` / `font-body` utilities of the Abacoding design system --}}
    <link href="https://fonts.bunny.net/css?family=figtree:400,500,600|baloo-2:400,600,700,800|nunito:400,600,700,800&display=swap" rel="stylesheet" />
